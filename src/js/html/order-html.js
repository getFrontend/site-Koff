export const orderHTML = `
                ...
                <table class="order__table table">
                    ...
                    <tr class="table__row">
                        ...
                        <td class="table__value">ivanka94@gmail.com</td>
                    </tr>
                    <tr class="table__row">
                        <td class="table__field">Адрес доставки</td>
                        <td class="table__value">Киев ул. Леси Украинки, 17, кв. 24</td>
                    </tr>
                    <tr class="table__row">
